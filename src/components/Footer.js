        ...
        <div class="relative mx-auto max-w-7xl px-4">
            ...
            <div class="w-full p-6 md:w-1/2 lg:w-2/12">
              <div class="h-full">
                ...
                <ul className="text-[#aaaaaa]">
                  ...
                  <li className="mb-4">
                    <Link to="/gradient" className="hover:underline">
                      Gradient Colors
                    </Link>
                  </li>
                  <li className="mb-4">
            ...
            <div class="w-full p-6 md:w-1/2 lg:w-2/12">
              <div class="h-full">
                ...
                <ul className="text-[#aaaaaa]">
                  <li className="mb-4">
                    <Link
                      to="https://github.com/visshnnu-tejaa-98/color-picker"
                      target="_blank"
                      className="hover:underline"
                    >
                      Github
                  ...
                  <li className="mb-4">
                    <Link
                      to="https://twitter.com/Venkattech2"
                      className="hover:underline"
                      target="_blank"
                    >
                      Twitter
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
              <Link
                to="https://www.instagram.com/aspiring_dev/"
                target="_blank"
                className="text-[#aaaaaa] hover:text-[#cccccc]"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
              ...
              <Link
                to="https://github.com/visshnnu-tejaa-98"
                className="text-[#aaaaaa] hover:text-[#cccccc]"
                target="_blank"
              >
                <svg
