...
import { threeToneGradientCopyCode } from "../utils/variables";
...
const GenerateGradientThreeTone = () => {
  ...
  return (
    <div className="text-[#cccccc] px-[7%] mb-10">
      <h1 className="text-center text-4xl mt-7 mb-3">Create Gradient</h1>
      <GradientTabs />
      <div className="flex flex-col items-center gap-5 md:flex md:justify-between md:flex-row">
        <table>
          <tbody>
            ...
            <tr>
              <th className="w-[100px] text-left h-[40px]">Color Three</th>
              <td>
                <div className="text-lg">
                  <input
                    type="color"
          ...
          <span
            ...
            onClick={() => {
              ...
              navigator.clipboard.writeText(
                threeToneGradientCopyCode([color1, color2, color3])
              );
              setTimeout(() => {
                setIsCopied(false);
              }, 500);
...
export default GenerateGradientThreeTone;
