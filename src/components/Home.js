...
const Home = () => {
  return (
    <div className="px-[7%] text-[#cccccc]">
      ...
      {/* Features */}
      <div>
        <section class="py-10 sm:py-16 lg:pt-32 lg:pb-10">
          <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="max-w-xl mx-auto text-center">
              <h2 class="mt-6 text-3xl font-bold leading-tight text-[#cccccc] sm:text-4xl lg:text-5xl">
                Our Features
              </h2>
            </div>
            <div class="grid items-center grid-cols-1 mt-12 gap-y-10 lg:grid-cols-5 sm:mt-20 gap-x-4">
              <div class="space-y-8 lg:pr-16 xl:pr-24 lg:col-span-2 lg:space-y-12">
                <div class="flex items-start">
                  ...
                  <div class="ml-5">
                    <h3 class="text-xl font-semibold text-[#cccccc]">
                      Solid Colors
                    </h3>
                    <p class="mt-3 text-base text-[#cccccc] opacity-75">
      ...
      {/* stay updated */}
      <section class="mb-32 text-gray-800 text-center pt-28 pb-10">
        <div class="flex flex-wrap justify-center">
          <div class="grow-0 shrink-0 flex-basis w-full lg:w-6/12 px-3">
            <div class="p-4 inline-block mb-6 w-15 h-15 rounded bg-[#7E22CE]">
              <span class="material-symbols-outlined text-[#cccccc] scale-150">
                mail
              </span>
            </div>
            <h2 class="text-3xl text-[#cccccc] font-semibold mb-6">
              Get Updated with Color Picker
            </h2>

            <p class="text-[#cccccc] opacity-75 mb-12">
            ...
            <div class="md:flex flex-row">
              <input
                type="text"
                class="form-control block w-full px-4 py-2 mb-2 md:mb-0 md:mr-2 text-xl font-normal text-[#cccccc] bg-transparent bg-clip-padding border border-solid rounded transition ease-in-out m-0 focus:text-[#cccccc] focus:bg-transparent focus:border-[#7E22CE] focus:outline-none"
                placeholder="Enter your email"
              />
              <button
                type="submit"
                class="inline-block px-7 py-3 bg-[#7E22CE] text-[#cccccc] text-lg font-semibold leading-snug rounded shadow-md hover:bg-[#7E22CE] hover:shadow-lg focus:bg-[#7E22CE] focus:shadow-lg focus:outline-none focus:ring-0 active:bg-[#7E22CE] active:shadow-lg transition duration-150 ease-in-out"
